                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            ...
                            <h2>R$ 27,00</h2>
                            <p>dolorem</p>
                            <a href="/product/3" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais detalhes</a>
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="/cart/3/add" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                            </div>
                        </div>
                    </div>
                </div>
