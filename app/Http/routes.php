...
Route::group(['prefix' => 'admin'], function() {
    Route::group(['prefix' => 'categories'], function(){
        ...
        Route::get( '/show', ['as'=>'admin.categories.show', 'uses' => 'AdminCategoriesController@show'] );
        ...
        Route::delete( '/destroy', ['as'=>'admin.categories.destroy', 'uses' => 'AdminCategoriesController@destroy'] );
    });
    ...
    Route::group(['prefix' => 'products'], function(){
        ...
        Route::get( '/show', ['as'=>'admin.products.show', 'uses' => 'AdminProductsController@show'] );
        ...
        Route::delete( '/destroy', ['as'=>'admin.products.destroy', 'uses' => 'AdminProductsController@destroy'] );
    });
});